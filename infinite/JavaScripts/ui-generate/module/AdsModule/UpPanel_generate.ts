 ...
 * TIME: 2025.03.15-11.43.47
 */
 
@UIBind('UI/module/AdsModule/UpPanel.ui')
export default class UpPanel_Generate extends UIScript {
	...
	private mContentTxt_1_Internal: mw.TextBlock
	public get mContentTxt_1(): mw.TextBlock {
		if(!this.mContentTxt_1_Internal&&this.uiWidgetBase) {
			this.mContentTxt_1_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/Canvas/Canvas_1/mContentTxt_1') as mw.TextBlock
		}
	...
	private mUpBtn_Internal: mw.StaleButton
	public get mUpBtn(): mw.StaleButton {
		if(!this.mUpBtn_Internal&&this.uiWidgetBase) {
			this.mUpBtn_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/Canvas/Canvas_1/mUpBtn') as mw.StaleButton
		}
