...
export default class RankItem_Generate extends UIScript {
	...
	private mHeightTextBlock_Internal: mw.TextBlock
	public get mHeightTextBlock(): mw.TextBlock {
		if(!this.mHeightTextBlock_Internal&&this.uiWidgetBase) {
			this.mHeightTextBlock_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/Canvas/mHeightTextBlock') as mw.TextBlock
		}
