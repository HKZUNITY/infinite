...
export default class BagTab_Generate extends UIScript {
	...
	public get mTextBlock(): mw.TextBlock {
		if(!this.mTextBlock_Internal&&this.uiWidgetBase) {
			this.mTextBlock_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mButton/mTextBlock') as mw.TextBlock
		}
