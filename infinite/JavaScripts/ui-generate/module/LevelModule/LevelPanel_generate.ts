...
export default class LevelPanel_Generate extends UIScript {
	...
	public get mLevelTextBlock(): mw.TextBlock {
		if(!this.mLevelTextBlock_Internal&&this.uiWidgetBase) {
			this.mLevelTextBlock_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/LevelBgImage/mLevelTextBlock') as mw.TextBlock
		}
