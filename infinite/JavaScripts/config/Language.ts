...
消耗{1}钻石即可修改称号*/
	...
	/**点击头像修改称号*/
	get Text_AlterTitle():ILanguageElement{return this.getElement(576)};
	/**试穿换装*/
	get Text_Cloth():ILanguageElement{return this.getElement(577)};
